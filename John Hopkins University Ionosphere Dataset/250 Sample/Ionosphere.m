...
%% loading data
load('IonosphereInputs.mat'); %IonosphereInputs(250x35)
load('IonosphereTargets.mat'); %IonosphereTargets(250x1)
IonosphereGroups = ismember(IonosphereTargets, 1); %IonosphereGroups(250x1)
