...
%% loading data
load('IonosphereInputs.mat'); %IonosphereInputs(150x35)
load('IonosphereTargets.mat'); %IonosphereTargets(150x1)
IonosphereGroups = ismember(IonosphereTargets, 1); %IonosphereGroups(150x1)
