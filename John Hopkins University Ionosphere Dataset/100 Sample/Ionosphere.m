...
%% loading data
load('IonosphereInputs.mat'); %IonosphereInputs(100x35)
load('IonosphereTargets.mat'); %IonosphereTargets(100x1)
IonosphereGroups = ismember(IonosphereTargets, 1); %IonosphereGroups(100x1)
