...
%% loading data
load('IonosphereInputs.mat'); %IonosphereInputs(300x35)
load('IonosphereTargets.mat'); %IonosphereTargets(300x1)
IonosphereGroups = ismember(IonosphereTargets, 1); %IonosphereGroups(300x1)
